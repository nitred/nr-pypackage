...
from . import utils, handle_list, handle_register
...
def index():
    ...
    return render_template('navigation_template.html',
                           page_title='database {{ current_table_name_lower }}',
                           page_heading='database {{ current_table_name_lower }}',
...
def list():
    ...
    return render_template('{{ current_table_name_lower }}/list.html',
                           page_title='Pydagger Pipelines',
                           page_heading='Pydagger Pipelines - List',
                           url_for_logout=url_for('auth.logout'),
...
def register():
    ...
    return render_template('{{ current_table_name_lower }}/register.html',
                           page_title='Pydagger Pipelines',
                           page_heading='Pydagger Pipelines - Register',
                           url_for_logout=url_for('auth.logout'),
                           url_for_back=url_for('{{ current_table_name_lower }}.index'),
...
#                            page_title='Pydagger Pipelines',
#                            page_heading='Pydagger Pipelines - Update',
#                            url_for_logout=url_for('auth.logout'),
#                            url_for_back=url_for('{{ current_table_name_lower }}.index'),
...
#                            page_title='Pydagger Pipelines',
#                            page_heading='Pydagger Pipelines - Deregister',
#                            url_for_logout=url_for('auth.logout'),
#                            url_for_back=url_for('{{ current_table_name_lower }}.index'),
